...
static struct clk icss_ocp_gclk = {
	.name		= "icss_ocp_gclk",
	.parent		= &l3_gclk,
	.init		= &omap2_init_clksel_parent,
	.clksel		= icss_ocp_clk_mux_sel,
	.clksel_reg	= AM33XX_CLKSEL_ICSS_OCP_CLK,
	.clksel_mask	= AM33XX_CLKSEL_0_0_MASK,
	.ops		= &clkops_null,
	.recalc		= &followparent_recalc,
};

static struct clk icss_iep_gclk = {
	.name 		= "icss_iep_gclk",
...
static struct clk icss_uart_gclk = {
	.name		= "icss_uart_gclk",
	.clkdm_name	= "icss_ocp_clkdm",
	.parent		= &per_192mhz_clk,
...
static struct omap_clk am33xx_clks[] = {
	...
	CLK(NULL,	"icss_ocp_gclk",	&icss_ocp_gclk,	CK_AM33XX),
	CLK(NULL,	"icss_uart_gclk",	&icss_uart_gclk,	CK_AM33XX),
	CLK(NULL,	"icss_iep_gclk",	&icss_iep_gclk,	CK_AM33XX),
