 ...
 * Fields are -
 * 	PWRSTST, PWRSTCTRL, RSTCTRL, RSTST
 */
static u16 off_fixup[][4] = {
	{ 0x0C, 0x08, 0x00, 0x04 },	/* AM33XX_PRM_PER_MOD */
	{ 0x04, 0x08, 0x00, 0x0C },	/* AM33XX_PRM_WKUP_MOD */
	{ 0x00, 0x04, 0x08, 0x08 },	/* AM33XX_PRM_MPU_MOD */
	/* XXX: PRM_DEVICE: offsets are invalid for powerdomain*/
	{ 0x00, 0x00, 0x00, 0x08 },	/* AM33XX_PRM_DEVICE_MOD */
	{ 0x00, 0x04, 0x00, 0x00 },	/* AM33XX_PRM_RTC_MOD */
	{ 0x00, 0x10, 0x04, 0x14 },	/* AM33XX_PRM_GFX_MOD */
	{ 0x00, 0x04, 0x00, 0x00 },	/* AM33XX_PRM_CEFUSE_MOD */
};
